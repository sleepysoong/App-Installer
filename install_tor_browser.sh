...
proot-distro login ubuntu --user $varname --shared-tmp -- env DISPLAY=:1.0 curl -sLO https://sourceforge.net/projects/tor-browser-ports/files/12.5.1/tor-browser-linux-arm64-12.5.1_ALL.tar.xz/download
...
Exec=proot-distro login ubuntu --user $varname --shared-tmp -- env DISPLAY=:1.0  tor-browser/Browser/start-tor-browser
