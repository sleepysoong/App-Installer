...
proot-distro login ubuntu --user $varname --shared-tmp -- env DISPLAY=:1.0 sudo -S apt install ./remarkable_1.87_all.deb -y
...
Name=Remarkable
Comment=
Exec=proot-distro login ubuntu --user $varname --shared-tmp -- env DISPLAY=:1.0 remarkable
Icon=remarkable
Categories=Office;
Path=
Terminal=false
