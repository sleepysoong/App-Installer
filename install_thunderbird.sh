...
proot-distro login ubuntu --user $varname --shared-tmp -- env DISPLAY=:1.0 wget https://thunderbird.io/files/thunderbird-ce-latest-linux.gtk.aarch64-nojdk.tar.gz -O thunderbird.tar.gz
